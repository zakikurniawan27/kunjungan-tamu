...
<section class="flex flex-col justify-center items-center gap-10">
    ...
    <div class="w-[30rem] h-max p-10 rounded-md shadow-md">
        ...
        <form action="{{ route('storeKeperluan', $tamu->id) }}" method="POST" class="flex flex-col gap-5">
            @csrf
            <label for="keperluan">Keperluan</label>
            <input type="text" name="keperluan" id="keperluan" placeholder="masukan keperluan anda" class="border-[1px] rounded-md p-2">
